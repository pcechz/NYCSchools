...
import com.pcechz.nycschools.data.db.SchoolDatabase;
...
public class AppModule {
    ...
    @Provides
    @Singleton
    SchoolDatabase provideSchoolDatabase(Application application) {
        return Room.databaseBuilder(application, SchoolDatabase.class, "schools.db").build();
    }

    @Provides
    @Singleton
    SchoolsDao provideSchoolDao(SchoolDatabase schoolDatabase) {
        return schoolDatabase.schoolsDao();
    }
